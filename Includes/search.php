...
<html>
<head>
<title>Vegetable Shop: <?php echo $type ?></title>
...
<?php include 'Includes/header.php'; ?>
			<div class="w3l_banner_nav_right" style="margin-top: -50px; padding: 0px;">
			<div class="w3l_banner_nav_right_banner3_btm">
				...
				<?php
					...
					else{$qry = "SELECT * FROM tbl_item WHERE ProductType='$type'";}
